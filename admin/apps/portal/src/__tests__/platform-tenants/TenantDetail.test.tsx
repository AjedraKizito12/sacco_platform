...
function renderDetail(t: TenantOut, canRetry = false, canImpersonate = false) {
  ...
  return render(
    <QueryClientProvider client={qc}>
      <TenantDetail tenant={t} canRetry={canRetry} canImpersonate={canImpersonate} canAssignPlan={false} canViewAudit={false} auditBar={<div data-entity-type="tenant" />} makerCheckerBanner={null} />
    </QueryClientProvider>,
  );
}
