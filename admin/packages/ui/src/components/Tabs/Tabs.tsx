...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ...
    className={cn(
      ...
      "bg-[var(--surface-sunken)] p-1 text-[var(--text-secondary)]",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      "font-medium text-[var(--text-body)] transition-all",
      ...
      "data-[state=active]:bg-[var(--surface-elevated)] data-[state=active]:text-[var(--text-primary)] data-[state=active]:shadow-[var(--shadow-sm)]",
      className,
    )}
    {...props}
  />
