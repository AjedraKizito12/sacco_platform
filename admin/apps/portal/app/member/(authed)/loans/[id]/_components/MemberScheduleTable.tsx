...
export interface MemberInstallmentRow {
  id: string;
...
const columns: DataTableProps<MemberInstallmentRow>["columns"] = [
  {
    id: "period_number",
...
export function MemberScheduleTable({ rows }: { rows: MemberInstallmentRow[] }) {
  ...
  return (
    <DataTable<MemberInstallmentRow>
      id="member-loan-schedule"
      columns={columns}
      data={pageRows}
      urlState={urlState}
      state={{
      ...
      emptyState={{
        ...
        description: "The repayment schedule appears here once disbursed.",
      }}
    />
  );
}
